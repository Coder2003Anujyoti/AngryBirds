...
var finalUserValue=0;
var finalUsersValue=0;
  const rollDice = () => {
    if (rolling) return;
    setRolling(true);
...
{ playerindex!=63 && computerindex!=63 && <>
      ...
      <div className="flex gap-8 mt-2">
        ...
        <div className="flex flex-col items-center">
          <span className="text-lg font-bold mb-2">Player 1</span>
        ...
        {/* Computer Dice */}
        <div className="flex flex-col items-center">
          <span className="text-lg font-bold mb-2">Player 2</span>
                  <div className="w-full flex items-center justify-center">
      ...
      {/* Roll Button */}
    <div className="w-full gap-8 flex flex-row justify-center flex-wrap items-center">
      <button
        onClick={rollDice}
        className="mt-6 px-4 font-bold py-2 bg-blue-600 text-white rounded hover:bg-blue-700 disabled:opacity-50"
        disabled={disp}
      >
        Roll Dice
      </button>
      ...
      }
      {
       ...
       &&
       <>
       <h1 className="my-4 text-center font-bold text-xl">Winner is {playerindex==63?"Player 1":"Player 2"}
       </h1>
