...
const adds=(i)=>{
  ...
  let s=k[Math.floor(Math.random()*k.length)].image;
 setPlayer(i)
 setComputer(s)
}
const rand=()=>{
...
useEffect(()=>{
 ...
 <div className="w-full py-6 flex flex-col">
    <h1 className="font-bold text-xl text-center underline-offset-8 underline">Select your Bird</h1>
...
{ toss==="Player" && <h1>Player turn first</h1>}
{ toss==="Computer" && <h1>Computer turn first</h1>}
